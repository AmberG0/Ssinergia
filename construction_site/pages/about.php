...
<head>
    ...
    <title>О компании — СтройМастер</title>
        ...
        <section id="info_page">
            ...
            <div class="info_content">
                <div class="info_block">
                    <img src="../image/logo.png" alt="Логотип СтройМастер">
                    <h2>СтройМастер — ваш надёжный партнёр в строительстве</h2>
                    <p>Компания «СтройМастер» работает на рынке строительных материалов и услуг с 2008 года. За это время мы зарекомендовали себя как надёжный поставщик качественных стройматериалов для частных застройщиков и крупных строительных компаний по всей России.</p>
                </div>
                ...
                <div class="info_block">
                    <h2>Наша миссия</h2>
                    <p>Мы стремимся обеспечить российские строительные компании и частных клиентов качественными материалами по доступным ценам. Наша цель — стать лидером рынка благодаря высокому уровню сервиса, широкому ассортименту и индивидуальному подходу к каждому клиенту.</p>
                </div>
